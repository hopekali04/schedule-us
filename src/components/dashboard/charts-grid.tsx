  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      <ChartCard
        ...
        description="Your goal completion progress over the last 6 months"
      >
      ...
      <ChartCard
        ...
        description="Distribution of your goals across different categories"
      >
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            <Tooltip
              formatter={(value) =>
                `${typeof value === "number" ? value.toFixed(0) : Number(value ?? 0).toFixed(0)}%`
              }
            />
